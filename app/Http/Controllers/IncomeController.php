...
//            if($request->income_type == "Roket Commission")
//            {
//                Virtualbd::create([
//                    'date'=>$date,
//                    'cash_in'=>$request->income_amount,
...
//            if($request->income_type == "Others"){
//                Balancebd::create(['cash_in'=>$request->income_amount]);
//            }
...
//            if($request->income_type == "Fund Transfer"){
//                Balancebd::create(['cash_in'=>$request->amount]);
//            }
...
//            if($request->income_type == "Remitance Disbursement"){
//                Virtualbd::create(['cash_in'=>$request->income_amount]);   //+
//            }

//            if($request->income_type == "B2B Transfer"){
//                Virtualbd::create(['cash_in'=>$request->income_amount]);
//            }
...
//            $virtualbdCashIn = Virtualbd::all()->sum('cash_in');
//            $virtualbdCashOut = Virtualbd::all()->sum('cash_out');
//            $balancebdCashIn = Balancebd::all()->sum('cash_in');
//            $balancebdCashOut = Balancebd::all()->sum('cash_out');

//        dd($virtualbdCashIn - $virtualbdCashOut);
//        dd($balancebdCashIn - $balancebdCashOut);
            //dd($request->all());
